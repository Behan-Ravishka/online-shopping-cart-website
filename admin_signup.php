...
<body>
    ...
    <div class="signup-container">
        ...
        if (isset($_SESSION['admin_signup_success']) && $_SESSION['admin_signup_success']) {
            echo '<div class="message-container success-message"><p>Admin signup successful!</p></div>';
            unset($_SESSION['admin_signup_success']);
        }

        if (isset($_SESSION['admin_signup_error']) && $_SESSION['admin_signup_error']) {
            echo '<div class="message-container error-message"><p>' . $_SESSION['admin_signup_error'] . '</p></div>';
